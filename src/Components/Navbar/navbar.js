...
function Navbar() {
    ...
    return (
        <div className={(position) ? "nav__main flex__center__space positionFixed" : "nav__main flex__center__space"}>
            ...
            <div>
                <button className="primary__button1 desktop__button">Log In</button>
                <button className="primary__button2 desktop__button">Sign up</button>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25px" height="25px" className="burger" onClick={() => setNavToggle(true)}><g data-name="Layer 2"><g data-name="menu"><rect width="24" height="24" opacity="0" transform="rotate(180 12 12)" /><rect width="18" height="2" x="3" y="11" rx=".95" ry=".95" /><rect width="18" height="10" x="3" y="16" rx=".95" ry=".95" /><rect width="18" height="2" x="3" y="6" rx=".95" ry=".95" /></g></g></svg>
            </div>
        </div>
    )
}
